            ...
            <section className="availabilityPage">
                    ...
                    <div className="availabilityPageClientInfo">
                        <div className="avtPageInputSection">
                            <div className="InputSectionText"><p className="text-Input">Informe o seu CEP</p></div>
                            <InputViability changeInput={inputChange}/>
                            <BtnProgress    incrementing={IncrementToProgressStep}decrementing={DecrementToProgressStep}value={CircleColor}/>
                        </div>
                        <PlainChoosed/>
                        <ClientCEPInfo/>
                    </div>
